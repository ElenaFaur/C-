...
// -- by placing these objects inside special wrapper objects that contain these behaviours

//decorator is a structural pattern that allows adding new behaviours to objects dynamically
